    ...
    def get_captcha(self):
        try:
            ...
            if exists(f"data/{label}"):
                ...
                print(f"[TRAIN] YOU NEED TO TRAIN {label}")
                return 
            print(f"[LABEL] {label}")
            ...
            for u in ta:
                ...
                def no_ai(md5_hash, tas):
                    try:
                        ...
                        mmp.close()
                        answ[tas] = "true"
                        #print(f'[INFO] {tas} | true')

                    except:
                        answ[tas] = "false"
                        #print(f'[INFO] {tas} | false')
